...
// 🌐 CORS CONFIGURATION - FIX MULTIPLE VALUES
// XÓA HOÀN TOÀN app.use(cors()) HIỆN TẠI VÀ THAY BẰNG:
...
app.use((req, res, next) => {
  ...
  res.setHeader('Access-Control-Allow-Headers', 'Content-Type, Authorization, X-Requested-With, X-Requested-By, X-Emergency-Access');

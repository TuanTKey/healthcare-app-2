...
// 🎯 LẤY TẤT CẢ HỒ SƠ BỆNH ÁN CỦA BỆNH NHÂN (PHẢI ĐẶT TRƯỚC '/:recordId')
router.get(
...
// 🎯 GHI NHẬN DẤU HIỆU SINH TỒN (PHẢI ĐẶT TRƯỚC '/:recordId')
router.post(
...
// 🎯 LẤY LỊCH SỬ DẤU HIỆU SINH TỒN (PHẢI ĐẶT TRƯỚC '/:recordId')
router.get(
...
// 🎯 THÊM TIỀN SỬ BỆNH LÝ (PHẢI ĐẶT TRƯỚC '/:recordId')
router.post(
...
// 🎯 LẤY TOÀN BỘ TIỀN SỬ BỆNH LÝ (PHẢI ĐẶT TRƯỚC '/:recordId')
router.get(
  '/patient/:patientId/medical-history',
  requireRole(ROLES.DOCTOR, ROLES.NURSE, ROLES.HOSPITAL_ADMIN, ROLES.PATIENT),
  requirePermission(PERMISSIONS.VIEW_MEDICAL_RECORDS),

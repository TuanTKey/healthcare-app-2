...
class AppointmentController {
  ...
  async createAppointment(req, res, next) {
    try {
      ...
      console.log('📋 [APPOINTMENT] Raw data received:', JSON.stringify(req.body));
      ...
      // Sanitize and validate appointmentDate
      if (appointmentData.appointmentDate) {
        ...
        appointmentData.appointmentDate = parsedDate;
        console.log('✅ [APPOINTMENT] Date validated:', appointmentData.appointmentDate);
      }

...
const PERMISSIONS = Object.freeze({
  ...
  // 🆕 TƯƠNG THÍCH VỚI ROUTE (SNAKE_CASE)
...
const ROLE_PERMISSIONS = Object.freeze({
  ...
  [ROLES.HOSPITAL_ADMIN]: [
    ...
    PERMISSIONS['MEDICAL.UPDATE_RECORDS'], PERMISSIONS['MEDICAL.DELETE_RECORDS'],
    PERMISSIONS['MEDICAL.EXPORT_RECORDS'],
    PERMISSIONS['VIEW_MEDICAL_RECORDS'], PERMISSIONS['CREATE_MEDICAL_RECORDS'],
    PERMISSIONS['UPDATE_MEDICAL_RECORDS'], PERMISSIONS['DELETE_MEDICAL_RECORDS'],
    ...
    // Consultation & Diagnosis - FULL ACCESS
    PERMISSIONS['CONSULTATION.VIEW'], PERMISSIONS['CONSULTATION.CREATE'],
    PERMISSIONS['CONSULTATION.UPDATE'], PERMISSIONS['CONSULTATION.DELETE'],
    PERMISSIONS['DIAGNOSIS.VIEW'], PERMISSIONS['DIAGNOSIS.CREATE'],
    PERMISSIONS['DIAGNOSIS.UPDATE'], PERMISSIONS['DIAGNOSIS.DELETE'],
    
    // Treatment - FULL ACCESS
    PERMISSIONS['TREATMENT.VIEW_PLANS'], PERMISSIONS['TREATMENT.CREATE_PLANS'],
    PERMISSIONS['TREATMENT.UPDATE_PLANS'],
    
    // Prescription - FULL ACCESS
    PERMISSIONS['PRESCRIPTION.VIEW'], PERMISSIONS['PRESCRIPTION.CREATE'],
    PERMISSIONS['PRESCRIPTION.UPDATE'], PERMISSIONS['PRESCRIPTION.DELETE'],
    ...
    PERMISSIONS['LAB.UPDATE_ORDERS'], PERMISSIONS['LAB.VIEW_RESULTS'],
    PERMISSIONS['LAB.CREATE_RESULTS'], PERMISSIONS['LAB.UPDATE_RESULTS'],
    PERMISSIONS['LAB.APPROVE_RESULTS'],
    ...
    PERMISSIONS['REPORT.EXPORT'], PERMISSIONS['EMERGENCY.ACCESS'], 
    PERMISSIONS['SYSTEM.VIEW_AUDIT_LOG'], PERMISSIONS['SYSTEM.CONFIG'], 
    PERMISSIONS['SYSTEM.BACKUP_DATA'], PERMISSIONS['SYSTEM.RESTORE_DATA'],
  ],
  ...
  [ROLES.PATIENT]: [
    ...
    // Self data access only (cả format cũ và mới)
    PERMISSIONS['MEDICAL.VIEW_RECORDS'], PERMISSIONS['VIEW_MEDICAL_RECORDS'],

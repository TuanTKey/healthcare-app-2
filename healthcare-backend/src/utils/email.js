...
class EmailService {
  constructor() {
    ...
    // 🧪 KIỂM TRA KẾT NỐI SMTP KHI KHỞI TẠO (async, không block)
    setImmediate(() => {
  ...
  /**
   * 🧪 XÁC THỰC KẾT NỐI SMTP (Không block startup)
   */
  async verifyConnection() {
    try {
      ...
      console.warn('⚠️ Gmail SMTP Connection failed (Dev mode):', error.message);
      console.log('💡 Email service tạm không khả dụng, tuy nhiên ứng dụng vẫn chạy bình thường');
